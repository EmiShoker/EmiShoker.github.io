      ...
      transition: {
        ...
        transitionStart: function (e, t) {
          ...
          const s = this,
            { params: a } = s;
          a.cssMode ||
            (a.autoHeight && s.updateAutoHeight(), Y({ swiper: s, runCallbacks: e, direction: t, step: "Start" }));
        },
        transitionEnd: function (e, t) {
          ...
          const s = this,
            { params: a } = s;
          (s.animating = !1),
            a.cssMode || (s.setTransition(0), Y({ swiper: s, runCallbacks: e, direction: t, step: "End" }));
        }
      },
      slide: N,
      loop: R,
